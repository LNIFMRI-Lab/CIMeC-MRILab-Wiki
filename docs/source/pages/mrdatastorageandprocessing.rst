...
Introduction
-------------
Management of the data collected at the MR Lab is based on the guidelines described in the CIMeC General Data Protection Regulation <link>, which applies Regulation (EU) 2016/679 `“General Data Protection Regulation” (GDPR) <https://docs.google.com/document/d/1Nfa8i61-7nWXPcwL1KpN1KWxp9Xo3NNA/edit?usp=sharing&ouid=103484475014003309094&rtpof=true&sd=true>`_, to scientific research. The two essential points to be considered in data management are:
